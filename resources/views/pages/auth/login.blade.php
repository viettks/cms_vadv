                ...
                <div class="login-content">
                    ...
                    <div class="login-form">
                        <div class="sufee-alert alert with-close alert-danger alert-dismissible fade">
                            ...
                            <span id="spAlert"></span>
                            <button type="button" class="close" aria-label="Close" id="btnCloseArlert">
                        ...
                        <form action="" method="post" onsubmit="return false;">
                            ...
                            <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" id="btnLogin">Đăng nhập</button>
                        </form>
                    </div>
                </div>
            </div>
